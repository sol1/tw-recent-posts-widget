...
A simple and flexible widget for WordPress which will show recent posts from selected category allowing increased customization to display recent posts.
...
2. The widget output based on it's settings
